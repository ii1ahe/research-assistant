...
container. The application is 4\,494 lines across 25 source files; the layering rule is enforced
...
The Architecture Decision Records in \texttt{docs/architecture.md} carry the reasoning behind the
choices this report argues for: the flat layout, PostgreSQL for both persistence concerns,
Protocol-based storage interfaces, the bounded-concurrency model, and the decision not to build an
HTTP API.
